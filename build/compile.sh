...
# 
# :Usage
echo "compile.sh [/? ^| debug ^| release ^| tests ^| verbosity:[q^|m^|n^|d] ^| project Project.sln"
echo ""
...
XXMSBUILD="dotnet build"
_platform_target="Mixed Platforms"
# 
...
# :compile
_option="/nologo /nr:false /m /verbosity:$__BuildVerbosity /p:Configuration=$__BuildType /p:Platform=\"$_platform_target\" /p:StrideSkipUnitTests=$__SkipTestBuild $Project /p:DeployExtension=false"
# 
