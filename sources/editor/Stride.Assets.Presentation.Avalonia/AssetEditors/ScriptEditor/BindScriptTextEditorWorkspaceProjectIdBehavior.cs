...
namespace Stride.Assets.Presentation.AssetEditors.ScriptEditor
{
    ...
    {
        public static readonly StyledProperty<PackageViewModel> PackageProperty = StyledProperty<PackageViewModel>.Register<BindScriptTextEditorWorkspaceProjectIdBehavior, PackageViewModel>("Package"); // T1
