...
namespace Stride.Assets.Presentation.AssetEditors.ScriptEditor
{
    ...
    public class SimpleCodeTextEditor : CodeTextEditor
    {
        ...
        public static readonly StyledProperty<IImage> ContextActionsIconProperty = StyledProperty<IImage>.Register<SimpleCodeTextEditor, IImage>(nameof(ContextActionsIcon));

        static SimpleCodeTextEditor ()
        {
            ContextActionsIconProperty.Changed.AddClassHandler<SimpleCodeTextEditor> (OnContextActionsIconChanged);
        }
        
        private static void OnContextActionsIconChanged(AvaloniaObject e, AvaloniaPropertyChangedEventArgs args)
        {
        ...
        public IImage ContextActionsIcon
        {
