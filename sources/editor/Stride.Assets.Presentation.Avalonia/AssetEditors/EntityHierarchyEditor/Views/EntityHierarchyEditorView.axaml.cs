...
namespace Stride.Assets.Presentation.AssetEditors.EntityHierarchyEditor.Views
{
    ...
    /// </summary>
    public abstract partial class EntityHierarchyEditorView : UserControl, IEditorView
    {
...
//             button.CommandParameter = (Keyboard.Modifiers & KeyModifiers.Control) == KeyModifiers.Control;
        }
    }
}
