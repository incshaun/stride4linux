...
namespace Stride.Assets.Presentation.Templates
{
    ...
    /// </summary>
    public partial class ProjectLibraryWindow : ModalWindow, INotifyPropertyChanged
    {
        ...
        public ProjectLibraryWindow(string defaultLibraryName)
        {
            ...
            var dispatcher = new DispatcherService(Dispatcher.UIThread);
        ...
        private void LibBoxTextChanged(object sender, Avalonia.Controls.TextChangedEventArgs e)
        {
