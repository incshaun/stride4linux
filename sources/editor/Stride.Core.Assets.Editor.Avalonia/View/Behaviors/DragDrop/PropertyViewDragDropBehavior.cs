...
namespace Stride.Core.Assets.Editor.View.Behaviors
{
    ...
    /// </summary>
    public class PropertyViewDragDropBehavior : DragDropBehavior<PropertyView, Control>
    {
        public static readonly StyledProperty<GraphViewModel> TargetProperty = StyledProperty<GraphViewModel>.Register<PropertyViewDragDropBehavior, GraphViewModel>("Target"); // T1
