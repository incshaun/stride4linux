...
namespace Stride.Core.Assets.Editor.View.Behaviors
{
    ...
    public class PropertyViewAutoExpandNodesBehavior : Behavior<PropertyView>
    {
		...
		{
			ViewModelProperty.Changed.AddClassHandler<PropertyViewAutoExpandNodesBehavior>(OnViewModelChanged);
		}
        ...
        /// </summary>
        public static readonly StyledProperty<GraphViewModel> ViewModelProperty = StyledProperty<GraphViewModel>.Register<PropertyViewAutoExpandNodesBehavior, GraphViewModel>(nameof(ViewModel), null); // T5
        ...
        private static void OnViewModelChanged(AvaloniaObject d, AvaloniaPropertyChangedEventArgs e)
        {
        ...
        private void PrepareItem(object sender, PropertyViewItemEventArgs e)
        {
            ...
            Dispatcher.UIThread.InvokeAsync(new Action(() => ExpandSingleProperties(e.Container)));
        }
