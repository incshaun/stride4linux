...
namespace Stride.Core.Assets.Editor.View
{
    ...
    /// </summary>
    public partial class AssetPickerWindow : ModalWindow, IAssetPickerDialog
    {
        /// <summary>
        /// Identifies the <see cref="Message"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<string> MessageProperty = StyledProperty<string>.Register<AssetPickerWindow, string>(nameof(Message), string.Empty); // T2
...
//             Height = Math.Min(Height, SystemParameters.WorkArea.Height);
        ...
        protected override void OnClosing(WindowClosingEventArgs e)
        {
            lock (ExpandedObjects)
            {
                ...
                var items = global::Avalonia.VisualTree.VisualExtensions.GetVisualChildren(DirectoryTreeView).Where (x => x is TreeViewItem).Select (x => (TreeViewItem) x);
