...
//         public static SettingsKey<int> WorkAreaHeight = new SettingsKey<int>("Internal/WorkAreaHeight", SettingsContainer, (int)SystemParameters.WorkArea.Height);
        public static SettingsKey<int> WindowWidth = new SettingsKey<int>("Internal/WindowWidth", SettingsContainer, 1920);
        public static SettingsKey<int> WindowHeight = new SettingsKey<int>("Internal/WindowHeight", SettingsContainer, 1080);
