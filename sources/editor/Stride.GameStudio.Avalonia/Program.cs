...
// 
 ...
 //       AppBuilder.Configure<AvaloniaApp>().UsePlatformDetect().LogToTrace().StartWithClassicDesktopLifetime(null);
        ...
        Console.WriteLine ("Starting Avalonia Game Studio - v2\n\n");
        global::Avalonia.AppBuilder.Configure<AvaloniaApp>().UsePlatformDetect().UseReactiveUI().StartWithClassicDesktopLifetime(null);
    }
//     
