...
//                 if (window is ICloseable asyncClosable)
//                 {
...
//                 else
        ...
        bool IDialogService.HasMainWindow => ((IClassicDesktopStyleApplicationLifetime)Application.Current?.ApplicationLifetime).MainWindow is not null; 
