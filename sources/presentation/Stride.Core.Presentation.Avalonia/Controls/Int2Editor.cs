...
namespace Stride.Core.Presentation.Controls
{
    public class Int2Editor : VectorEditorBase<Int2?>
    {
        ...
        /// </summary>
        public static readonly StyledProperty<int> XProperty = StyledProperty<int>.Register<Int2Editor, int>("X", 0, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValueInt); // T9C

        /// <summary>
        /// Identifies the <see cref="Y"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<int> YProperty = StyledProperty<int>.Register<Int2Editor, int>("Y", 0, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValueInt); // T9C
