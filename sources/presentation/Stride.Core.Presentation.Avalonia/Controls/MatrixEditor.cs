...
namespace Stride.Core.Presentation.Controls
{
    public class MatrixEditor : VectorEditorBase<Matrix?>
    {
        ...
        /// </summary>
        public static readonly StyledProperty<float> M11Property = StyledProperty<float>.Register<MatrixEditor, float>("M11", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M12"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M12Property = StyledProperty<float>.Register<MatrixEditor, float>("M12", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M13"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M13Property = StyledProperty<float>.Register<MatrixEditor, float>("M13", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M14"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M14Property = StyledProperty<float>.Register<MatrixEditor, float>("M14", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M21"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M21Property = StyledProperty<float>.Register<MatrixEditor, float>("M21", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M22"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M22Property = StyledProperty<float>.Register<MatrixEditor, float>("M22", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M23"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M23Property = StyledProperty<float>.Register<MatrixEditor, float>("M23", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M24"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M24Property = StyledProperty<float>.Register<MatrixEditor, float>("M24", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M31"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M31Property = StyledProperty<float>.Register<MatrixEditor, float>("M31", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M32"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M32Property = StyledProperty<float>.Register<MatrixEditor, float>("M32", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M33"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M33Property = StyledProperty<float>.Register<MatrixEditor, float>("M33", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M34"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M34Property = StyledProperty<float>.Register<MatrixEditor, float>("M34", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M41"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M41Property = StyledProperty<float>.Register<MatrixEditor, float>("M41", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M42"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M42Property = StyledProperty<float>.Register<MatrixEditor, float>("M42", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M43"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M43Property = StyledProperty<float>.Register<MatrixEditor, float>("M43", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C

        /// <summary>
        /// Identifies the <see cref="M44"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<float> M44Property = StyledProperty<float>.Register<MatrixEditor, float>("M44", 0.0f, defaultBindingMode : BindingMode.TwoWay, coerce: CoerceComponentValue); // T9C
