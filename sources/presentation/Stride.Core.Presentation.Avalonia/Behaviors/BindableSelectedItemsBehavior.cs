...
namespace Stride.Core.Presentation.Behaviors
{
    ...
    public abstract class BindableSelectedItemsBehavior<T> : DeferredBehaviorBase<T> where T : Control
    {
		...
		{
			SelectedItemsProperty.Changed.AddClassHandler<BindableSelectedItemsBehavior<T>>(SelectedItemsChanged);
		}
        ...
        /// </summary>
        public static readonly StyledProperty<IObservableList<object>> SelectedItemsProperty = StyledProperty<IObservableList<object>>.Register<BindableSelectedItemsBehavior<T>, IObservableList<object>>(nameof(SelectedItems), null);

        /// <summary>
        /// Identifies the <see cref="GiveFocusOnSelectionChange"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<bool> GiveFocusOnSelectionChangeProperty = StyledProperty<bool>.Register<BindableSelectedItemsBehavior<T>, bool>(nameof(GiveFocusOnSelectionChange), true);
