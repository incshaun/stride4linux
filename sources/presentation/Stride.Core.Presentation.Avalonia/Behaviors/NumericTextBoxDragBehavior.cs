...
{
    public class NumericTextBoxDragBehavior : MouseMoveCaptureBehaviorBase<NumericTextBox>
    {
        ...
        /// </summary>
        public static readonly StyledProperty<Cursor> DragCursorProperty = StyledProperty<Cursor>.Register<NumericTextBox, Cursor>(nameof(DragCursor), new Cursor(StandardCursorType.SizeAll)); // T2
...
//             if (AssociatedObject.AllowMouseDrag && dragState == DragState.Starting && e.GetCurrentPoint((Control)sender).Properties.IsLeftButtonPressed)
//             {
...
//             dragState = DragState.None;
        ...
        private void HostQueryCursor(object sender, EventArgs e)
        {
//             if (!IsContentHostPart(e.OriginalSource))
//                 return;
// 
