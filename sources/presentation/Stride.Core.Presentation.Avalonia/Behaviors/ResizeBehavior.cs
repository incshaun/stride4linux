...
namespace Stride.Core.Presentation.Behaviors
{
    public sealed class ResizeBehavior : Behavior<Control>
    {
        ...
        /// </summary>
        public static readonly StyledProperty<Size> SizeRatioProperty = StyledProperty<Size>.Register<ResizeBehavior, Size>(nameof(SizeRatio)); // T1
        ...
        {
            return !double.IsNaN(SizeRatio.Width) && !double.IsInfinity(SizeRatio.Width) && SizeRatio.Width >= 1
