...
namespace Stride.Core.Presentation.Behaviors
{
    ...
    public abstract class OnEventBehavior : Behavior<AvaloniaObject>
    {
        ...
        /// </summary>
        public static readonly StyledProperty<string> EventNameProperty = StyledProperty<string>.Register<OnEventBehavior, string>("EventName");

        /// <summary>
        /// Identifies the <see cref="EventOwnerType"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<Type> EventOwnerTypeProperty = StyledProperty<Type>.Register<OnEventBehavior, Type>("EventOwnerType");

        /// <summary>
        /// Identifies the <see cref="HandleEvent"/> dependency property.
        /// </summary>
        public static readonly StyledProperty<bool> HandleEventProperty = StyledProperty<bool>.Register<OnEventBehavior, bool>("HandleEvent");
