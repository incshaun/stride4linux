...
namespace Stride.Core.Presentation.Windows
{
    ...
    public class MessageBox : MessageDialogBase
    {
        ...
        /// </summary>
        public static readonly StyledProperty<IImage> ImageProperty = StyledProperty<IImage>.Register<MessageBox, IImage>(nameof(Image)); // T1
...
//             CommandBindings.Add(new CommandBinding(ApplicationCommands.Copy, (_, __) => SafeClipboard.SetDataObject(Content ?? string.Empty, true)));
        ...
        public static async Task<int> Show(string message, string caption = "", [NotNull] IEnumerable<DialogButtonInfo> buttons = null, MessageBoxImage image = MessageBoxImage.None)
