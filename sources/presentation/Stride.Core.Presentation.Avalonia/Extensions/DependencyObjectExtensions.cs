...
//         }
        ...
        /// <summary>
        /// Sets the value of a DependencyProperty on a AvaloniaObject and all its logical children.
        /// </summary>
        /// <param name="source">Root AvaloniaObject of which to set the DependencyProperty value.</param>
        ...
        public static void DeepSetValue([NotNull] this AvaloniaObject source, [NotNull] AvaloniaProperty property, object value)
        {
            ...
            foreach (object child in LogicalExtensions.GetLogicalChildren(source as dynamic))
            {
        ...
        public static Visual FindVisualRoot([NotNull] this AvaloniaObject source)
        {
            ...
            while (source != null)
            {
                ...
                source = Avalonia.VisualTree.VisualExtensions.GetVisualParent(root);
            }
            return root;
        }
...
//             if (source == null) throw new ArgumentNullException(nameof(source));
// 
//             return FindParentOfType<T>(source, Avalonia.VisualTree.VisualExtensions.GetVisualParent);
//         }
...
//             if (source == null) throw new ArgumentNullException(nameof(source));
// 
//             return FindParentOfType<T>(source, LogicalExtensions.GetLogicalParent);
//         }
...
//                 d => LogicalExtensions.GetLogicalChildren(d).Cast<AvaloniaObject>().Count(),
//                 (d, i) => LogicalExtensions.GetLogicalChildren(d).Cast<AvaloniaObject>().ElementAt(i));
//         }
