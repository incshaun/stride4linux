...
namespace Stride.Core.Presentation.Core
{
    ...
    /// </summary>
    public class FocusManager : Control {
		static FocusManager ()
		{
			IsFocusedProperty.Changed.AddClassHandler<FocusManager>(OnIsFocusedPropertyChanged);
		}

        /// <summary>
        /// Identify the IsFocused attached dependency property.
        /// </summary>
        public static readonly AttachedProperty<bool> IsFocusedProperty = AvaloniaProperty<bool>.RegisterAttached<FocusManager, Control, bool>("IsFocused", false);
