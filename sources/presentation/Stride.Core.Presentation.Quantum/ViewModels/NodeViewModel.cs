...
{
    public interface INodeViewModel : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        public IEnumerable<NodePresenterCommandWrapper> Commands { get; }
        public IReadOnlyDictionary<string, object> AssociatedData { get; }
        public string Name { get; }
        public int? Order { get; }
        public (Type declarer, int token)? sortingHint { get ; }
    ...
    public class NodeViewModelBase : DispatcherViewModel, INodeViewModel, IDynamicMetaObjectProvider
    {
        ...
        private readonly AutoUpdatingSortedObservableCollection<INodeViewModel> children = new AutoUpdatingSortedObservableCollection<INodeViewModel>(new AnonymousComparer<INodeViewModel>(CompareChildren), nameof(Name), nameof(NodeIndex), nameof(Order));
        ...
        protected readonly List<INodePresenter> nodePresenters;
        protected readonly GraphViewModel owner;
        ...
        /// </summary>
        public IReadOnlyCollection<INodeViewModel> Children { get { return initializingChildren != null ? (IReadOnlyCollection<INodeViewModel>)initializingChildren : children; } }
        ...
        /// </summary>
        public int? Order => NodePresenters.First().Order;
        ...
        /// </summary>
        public int VisibleChildrenCount => Children.Count(x => ((NodeViewModelBase) x).IsVisible);
        ...
        protected internal NodeViewModelBase ([NotNull] GraphViewModel ownerViewModel, INodeViewModel parent, [NotNull] string baseName, Type nodeType, [NotNull] List<INodePresenter> nodePresenters) : base(ownerViewModel.ServiceProvider)
        {
            ...
            ((NodeViewModelBase)parent)?.AddChild(this);
        }
        ...
        private static int CompareChildren([NotNull] INodeViewModel a, [NotNull] INodeViewModel b)
        {
        ...
        private void AddChild([NotNull] INodeViewModel child) => ChangeAndNotify(() => { child.Parent = this; ((ICollection<INodeViewModel>)initializingChildren ?? children).Add(child); }, $"{GraphViewModel.HasChildPrefix}{child.Name}", child.Name);
        ...
        private void RemoveChild([NotNull] INodeViewModel child) => ChangeAndNotify(() => { child.Parent = null; ((ICollection<INodeViewModel>)initializingChildren ?? children).Remove(child); }, $"{GraphViewModel.HasChildPrefix}{child.Name}", child.Name);
        ...
        protected void ValueChanging(object sender, ValueChangingEventArgs valueChangingEventArgs)
        {
            OnValueChanging();
        }

        protected void ValueChanged(object sender, ValueChangedEventArgs valueChangedEventArgs)
        {
            OnValueChanged();
        }

        protected void AttachedPropertyUpdated(ref PropertyContainer propertycontainer, PropertyKey propertykey, object newvalue, object oldvalue)
        {
        ...
        {
            valueChanging = true;
            ((NodeViewModelBase)Parent)?.NotifyPropertyChanging(Name);
            OnPropertyChanging(nameof(NodeValue));
        }

        private void OnValueChanged()
        {
            ((NodeViewModelBase)Parent)?.NotifyPropertyChanged(Name);
    ...
    {
        public delegate INodeViewModel Builder ([NotNull] GraphViewModel ownerViewModel, INodeViewModel parent, [NotNull] string baseName, Type nodeType, [NotNull] List<INodePresenter> nodePresenters);
        
        public static Builder builder = null;
        
        public static INodeViewModel Build ([NotNull] GraphViewModel ownerViewModel, INodeViewModel parent, [NotNull] string baseName, Type nodeType, [NotNull] List<INodePresenter> nodePresenters)
        {
            return builder (ownerViewModel, parent, baseName, nodeType, nodePresenters);
        }
    }
}
